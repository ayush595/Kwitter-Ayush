...
part4= "<span class='glyphicon glyphicon-thumbs-up'> likes: " + likes + "</span>  </button> ";
part5= "<button class='btn btn-danger' id='" + firebase_message_id + "' onclick='reply(this.id)'> REPLY </button>";
...
likes: newlikees
 ...
 function reply(msgid) {
    btnid = msgid;
    part6 = "<input id='reply' class='form-control' placeholder='reply here'> <br> <button id='sned'>SEND </button>";
    document.getElementById("replydbl").innerHTML += part6 ;
